...
struct struct_HateList {
	...
	int64 last_modified; // we need to remove this if it gets higher than 10 mins
};
...
public:
	...
	Mob *GetClosestEntOnHateList(Mob *hater, bool skip_mezzed = false, bool clients_first = true);
