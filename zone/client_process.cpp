...
void Client::BulkSendMerchantInventory(int merchant_id, int npcid) {
	...
	uint32 numItemSlots = EQ::invtype::MERCHANT_SIZE; //The max number of items passed in the transaction.
	...
	if(to_bucket)
	{
		...
		if (RuleB(Character, SharedBankPlat))
		{
			if (to_bucket == &m_pp.platinum_shared || from_bucket == &m_pp.platinum_shared)
			{
				...
				this->Message(13, "::: WARNING! ::: SHARED PLATINUM BANK IS DISABLED AND YOUR PLATINUM MAY BE DESTROYED IF YOU PUT IT HERE");
				this->Message(14, "::: WARNING! ::: SHARED PLATINUM BANK IS DISABLED AND YOUR PLATINUM MAY BE DESTROYED IF YOU PUT IT HERE");
			}
		}
		else{
			if (to_bucket == &m_pp.platinum_shared || from_bucket == &m_pp.platinum_shared){
