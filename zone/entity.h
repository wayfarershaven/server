...
public:
	...
	void	UpdateConLevels(Client *specific_target);
	void	QueueClientsCreateSpawn(Mob *sender, const EQApplicationPacket *app, bool ignore_sender=false, bool ackreq = true);
