...
bool Client::SwapItem(MoveItem_Struct* move_in) {
	...
	LogInventory("Player [{}] on src_slot_id [{}] - dst_slot_id [{}] - SHARED BANK BEGIN [{}] - SHARED BANK END [{}] - SHARED BANK BAG BEGIN [{}] - SHARED BANK BAG END [{}] .", GetName(), src_slot_id, dst_slot_id, EQ::invslot::SHARED_BANK_BEGIN, EQ::invslot::SHARED_BANK_END, EQ::invbag::SHARED_BANK_BAGS_BEGIN, EQ::invbag::SHARED_BANK_BAGS_END);
