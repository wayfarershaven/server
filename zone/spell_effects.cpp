...
int64 Client::GetFocusEffect(focusType type, uint16 spell_id, Mob *caster)
{
...
int64 NPC::GetFocusEffect(focusType type, uint16 spell_id, Mob* caster) {
...
int64 Mob::GetFcDamageAmtIncoming(Mob *caster, int32 spell_id)
{
