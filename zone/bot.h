...
public:
	...
	virtual int64 GetActSpellDamage(uint16 spell_id, int32 value, Mob* target = nullptr);
	virtual int64 GetActSpellHealing(uint16 spell_id, int32 value, Mob* target = nullptr);
