...
bool Corpse::Save() {
	...
	/* Create New Corpse*/
	if (corpse_db_id == 0) {
		corpse_db_id = database.SaveCharacterCorpse(char_id, corpse_name, zone->GetZoneID(), zone->GetInstanceID(), ce, m_Position, consented_guild_id, RuleB(Character, UsePlayerCorpseBackups));
	}
	/* Update Corpse Data */
	else{
