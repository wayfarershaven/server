...
{
    Log(Logs::General, Logs::WorldServer, "Delete instance Routine Entered");
...
{
    Log(Logs::General, Logs::WorldServer, "Move Char Out instance Entered");
...
{
    Log(Logs::General, Logs::WorldServer, "PurgeExpiredInstances Routine Entered");
