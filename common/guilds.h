...
typedef enum {
	...
	GUILD_ACTION_SEND_THE_WHOLE_GUILD_E__MAIL	= 21,
	...
	GUILD_ACTION_REAL_ESTATE_GUILD_PLOT__BUY	= 27,
	GUILD_ACTION_REAL_ESTATE_GUILD_PLOT__SELL	= 28,
