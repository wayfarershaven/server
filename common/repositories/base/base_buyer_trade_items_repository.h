...
public:
	...
	)
	{
		...
		if (results.RowCount() == 1) {
			...
			e.slot_id   = static_cast<int32_t>(atoi(row[2]));
			e.item_id   = static_cast<int32_t>(atoi(row[3]));
			e.item_qty  = static_cast<int32_t>(atoi(row[4]));
			e.Item_icon = static_cast<int32_t>(atoi(row[5]));
			e.item_name = static_cast<int32_t>(atoi(row[6]));
	...
	)
	{
		...
		v.push_back(columns[4] + " = " + std::to_string(e.item_qty));
		v.push_back(columns[5] + " = " + std::to_string(e.Item_icon));
		v.push_back(columns[6] + " = " + std::to_string(e.item_name));
	...
	)
	{
		...
		v.push_back(std::to_string(e.item_name));
