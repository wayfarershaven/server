...
RULE_BOOL(Zone, DisbandGroups, false, "Enabled breaking of group when leader disbands (Used if groups are crashing)")
RULE_CATEGORY_END()
...
RULE_BOOL(Combat, Classic2HBAnimation, true, "2HB will use the 2 hand piercing animation instead of the overhead slashing animation")
RULE_CATEGORY_END()
