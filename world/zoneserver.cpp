    ...
    switch (opcode) {
        ...
        case ServerOP_Consent_Response: {
		    ...
		    if (owner_zs) {
				...
				Log(Logs::Detail, Logs::World_Server, "Unable to locate zone record for zone id [%i] or instance id [%i] in zoneserver list for ServerOP_Consent_Response operation", s->zone_id, s->instance_id);
			}
