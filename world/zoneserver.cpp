...
void ZoneServer::HandleMessage(uint16 opcode, const EQ::Net::Packet &p) {
	...
	case ServerOP_ChannelMessage: {
		...
		if (scm->chan_num == ChatChannel_Tell || scm->chan_num == ChatChannel_TellEcho) {
			...
			if (scm->chan_num == ChatChannel_Auction || scm->chan_num == ChatChannel_OOC || scm->chan_num == ChatChannel_Auction || scm->chan_num == ChatChannel_Broadcast || scm->chan_num == ChatChannel_Guild || ChatChannel_UCSRelay
